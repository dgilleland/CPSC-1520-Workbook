...
To grab your first sample starter kit, ensure you have the following set up on your computer:

1. VS Code and a copy of this workbook.
2. NPM Installed
3. PNPM Installed

Once that's in place, follow the [instructions for your first starter kit](../sk/-how-to-/ReadMe.md).
